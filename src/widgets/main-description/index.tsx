    ...
    >
      <div className="flex flex-col gap-6 md:gap-8">
        ...
        <p className="text-base md:text-lg text-start text-[#F9F9F9] max-w-full md:max-w-[50%]">
          Help the Friends of Zion Museum continue to bring these incredible
          stories to life. Your contribution will directly impact our ability to
          develop new and engaging exhibits, enhance our technological
          offerings, and ensure that the powerful narratives of the friends of
          Zion resonate with visitors from around the world.
        </p>
        <div className="flex flex-col md:flex-row gap-3 md:gap-4 w-full items-center justify-start mt-4 max-w-full md:max-w-[50%]">
          <Button
            type="button"
            variant="orange"
            className="w-full md:w-auto text-base md:text-lg font-semibold py-3 px-6 md:px-8"
          >
            Donate now
          </Button>
          <a
